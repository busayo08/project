    ...
    <section>
        ...
        <div class="col-3 ">
              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <br><br><br><br><br><br><br><br><br> <a class="nav-link active bg-warning" id="v-pills-home-tab" data-toggle="pill" href="dashboard.php" role="tab"
          ...
          <div class="card text-center" style="width: 15rem; margin-top: -40px">
                                      ...
                                      <div class="col-sm-4">
                                        ...
                                        <p><b>Status: <?php echo $status_r; ?></b></p>
                                        <p><b>Modified Date: <?php echo $date; ?></b></p>
                                        <a href="edit_meal.php?edit=<?php echo $id ?>" class="btn btn-warning" style="margin-bottom:10px;">Edit Meal</a>
                                          </div>
